"""Shared runtime settings for Evo-1 scripts."""
...
IMAGE_SIZE = int(os.getenv("EVO1_IMAGE_SIZE", "448"))
MAX_VIEWS = int(os.getenv("EVO1_MAX_VIEWS", "3"))
TARGET_STATE_DIM = int(os.getenv("EVO1_STATE_DIM", "24"))

DEFAULT_SERVER_HOST = os.getenv("EVO1_SERVER_HOST", "0.0.0.0")
DEFAULT_SERVER_PORT = int(os.getenv("EVO1_SERVER_PORT", "9000"))
DEFAULT_SERVER_URI = os.getenv("EVO1_SERVER_URI", f"ws://127.0.0.1:{DEFAULT_SERVER_PORT}")
DEFAULT_MAX_MESSAGE_SIZE = int(os.getenv("EVO1_MAX_MESSAGE_SIZE", "100000000"))
