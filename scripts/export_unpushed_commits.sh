...
repo_root="$(cd "${EVO1_EXPORT_REPO:-$script_dir/..}" && pwd)"
base_ref="${EVO1_EXPORT_BASE:-origin/main}"
timestamp="$(date -u +%Y%m%dT%H%M%SZ)"
out_dir="${EVO1_EXPORT_DIR:-$repo_root/exports/unpushed_commits_$timestamp}"
