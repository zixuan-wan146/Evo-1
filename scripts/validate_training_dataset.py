...
from Evo_1.dataset.config_utils import resolve_dataset_config_paths, validate_dataset_config_structure  # noqa: E402
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Validate Evo-1 simulation training dataset structure.")
    parser.add_argument("--dataset-config", default="Evo_1/dataset/config.yaml", help="Dataset YAML config to validate.")
    parser.add_argument(
        "--dataset-base-dir",
        default="Evo_1",
